...
export class HomeComponent implements OnInit {
  ...
  displayDialog = false;
  newEmployee = true;
  employee: Employee = HomeComponent.createEmployee();
  selectedEmployee: Employee;
  employeeErrors: any = HomeComponent.createEmployeeErrors();
  rowsNumb = 2;
  ...
  private showDialog() {
    ...
    if (this.newEmployee) {
      this.employee = HomeComponent.createEmployee();
    } else {
      this.employee = HomeComponent.cloneEmployee(this.selection[0]);
    }
    this.displayDialog = true;
    this.employeeErrors = HomeComponent.createEmployeeErrors();
  }
